...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String IMAGE_DIR = "/DCIM/Camera";
    private int GALLERY = 1, CAMERA = 2;
    private Button btn_gambar_lainnya;

    private void requesMultiplePermissions(){
    ...
    private String saveImage(Bitmap bitmap){
        ...
        File walpaperDirectory = new File(Environment.getExternalStorageDirectory() + IMAGE_DIR);
